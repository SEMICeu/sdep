...
The reference implementation is deployed in production as **SDEP-NL** for the Netherlands, enabling competent authorities (CA) and short-term rental platforms (STR) to exchange regulated-area and rental-activity data in accordance with EU legislation.

https://sdep.gov.nl/api/docs

The PRD environment includes the **EU-harmonized STR component** and the **SDEP-NL-specific CA component**.
...
To request production credentials, please email us using the contact details listed at <https://sdep.gov.nl/api/docs> and include the following details in your request:
